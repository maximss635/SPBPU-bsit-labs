    ...
    /* [size_is][out] */ unsigned char *buffer)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&Interface_StubDesc,
                  (PFORMAT_STRING) &AppInterface__MIDL_ProcFormatString.Format[114],
                  ( unsigned char * )&buffer_size);
    ...
    /* [size_is][out] */ unsigned char *buffer)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&Interface_StubDesc,
                  (PFORMAT_STRING) &AppInterface__MIDL_ProcFormatString.Format[150],
                  ( unsigned char * )&buffer_size);
    ...
    /* [size_is][out] */ unsigned char *buffer)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&Interface_StubDesc,
                  (PFORMAT_STRING) &AppInterface__MIDL_ProcFormatString.Format[186],
                  ( unsigned char * )&buffer_size);
    ...
    /* [size_is][out] */ unsigned char *buffer)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&Interface_StubDesc,
                  (PFORMAT_STRING) &AppInterface__MIDL_ProcFormatString.Format[222],
                  ( unsigned char * )&buffer_size);
    ...
    /* [size_is][out] */ unsigned char *buffer)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&Interface_StubDesc,
                  (PFORMAT_STRING) &AppInterface__MIDL_ProcFormatString.Format[258],
                  ( unsigned char * )&buffer_size);
    ...
    /* [size_is][out] */ unsigned char *buffer)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&Interface_StubDesc,
                  (PFORMAT_STRING) &AppInterface__MIDL_ProcFormatString.Format[294],
                  ( unsigned char * )&buffer_size);
